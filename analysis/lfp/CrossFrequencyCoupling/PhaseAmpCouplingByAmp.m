function [ PhaseAmpCoup ] = PhaseAmpCouplingByAmp( sig1phase,sig1amp,sig2amp,numbins )
...
PhaseAmpCoup.ampbins = ampbins;
PhaseAmpCoup.phasebins = phasebins;
PhaseAmpCoup.sig2powerskew = sig2powerskew;
PhaseAmpCoup.sig2prefangle = sig2prefangle;
PhaseAmpCoup.phaseamphist = phaseamphist;
PhaseAmpCoup.sig1amp = sig1amp;
PhaseAmpCoup.sig2amp = sig2amp;
PhaseAmpCoup.gasphist = hist3([sig1amp,sig2amp],{ampbins,ampbins});
